...
namespace StoreApi.Interfaces
{
    public interface ISanPhamRepository
    {
        ...
        IEnumerable<SanPham> SanPham_FilterShop(int lspId, int branchId, int machineId, int wireId, int priceFrom, int priceTo, string search, string sort, int pageIndex,int pageSize, out int count );
    }
}