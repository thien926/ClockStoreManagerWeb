...
function AdminNCCControl(props) {
    ...
    return (
        <div className="row">
            <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <button onClick={props.actionAdd} type="button" className="btn btn-primary">Thêm nhà cung cấp <i className="fa fa-plus-circle" aria-hidden="true" /></button>
            </div>
...
export default AdminNCCControl
