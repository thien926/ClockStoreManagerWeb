...
function AdminBillPaging(props) {
    ...
    const [notFound, setNotFound] = useState('Không tìm thấy hóa đơn nào!');
    ...
    useEffect(() => {
        ...
        if (dataValue.listHD && dataValue.listHD.length > 0) {
            ...
            setNext(null);
            setPrevious(null);
            setNotFound('Không tìm thấy hóa đơn nào!');
        }
    }, [dataValue])
    return (
...
export default AdminBillPaging
