...
function AdminCouponPaging(props) {
    ...
    const [notFound, setNotFound] = useState('Không tìm thấy phiếu nhập nào!');
    ...
    useEffect(() => {
        ...
        if (dataValue.listPN && dataValue.listPN.length > 0) {
            ...
            setNext(null);
            setPrevious(null);
            setNotFound('Không tìm thấy phiếu nhập nào!');
        }
    }, [dataValue])
    return (
...
export default AdminCouponPaging
